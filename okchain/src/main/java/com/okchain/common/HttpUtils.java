...
//    public static String sendPostDataByMap(String url, Map<String, String> map, String encoding) throws
...
//    }
    ...
    public static String sendPostDataByJson(String url, String json, String encoding) throws
            /*ClientProtocolException,*/ IOException {
        String result = "";
